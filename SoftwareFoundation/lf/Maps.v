...
Proof.
  ...
  unfold t_update.
  intros x0.
  destruct (eqb_string x x0) eqn:He.
  - reflexivity.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  apply iff_reflect.
  split.
  - intros. rewrite H. now rewrite <- eqb_string_refl.
  - intros. apply eqb_string_true_iff. apply H.
Qed.
(** [] *)
...
Proof.
  ...
  intros.
  destruct (eqb_string x x0) eqn:He.
  - apply eqb_string_true_iff in He.
    now rewrite He.
  - reflexivity.
Qed.
(** [] *)
